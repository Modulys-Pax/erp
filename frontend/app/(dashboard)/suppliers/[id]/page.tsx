...
import { supplierApi, UpdateSupplierDto } from '@/lib/api/supplier';
...
export default function EditSupplierPage() {
  ...
  const updateMutation = useMutation({
    mutationFn: (data: UpdateSupplierDto) => supplierApi.update(id, data),
    onSuccess: async () => {
  ...
  if (!supplier) {
    return (
      <div className="space-y-6">
        ...
        <SectionCard><p className="text-sm text-muted-foreground text-center py-8">Fornecedor não encontrado.</p></SectionCard>
      </div>
    );
  }
  ...
  return (
    <div className="space-y-6">
      <PageHeader title="Editar Fornecedor" subtitle="Atualize os dados do fornecedor" />
